...
<div class="title">
  Laporan Simpanan Koperasi
  <div class="subtitle">
    Periode: 01 Januari 2024 - 31 Desember 2024
  </div>
</div>
<div>
  <p>Nama Anggota : {{ $carinama }}</p>
  <p>Jenis Simpanan : Simpanan {{ $carijenis }}</p>
  <p>Total Simpanan : RP.{{ $total }}</p>
</div>
    ...
    <tbody>
      @forelse ($filteredSimpanan as $simp)
          <tr>
              ...
              <td>{{ $simp->tgl_simpan }}</td>
              <td>{{ $simp->jumlah_simpanan }}</td>
          </tr>
      @empty
          <tr>
