  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="{{ route('home') }}" >
        <img src="{{ asset('tamplate/assets/img/logo-koperasi.png')}}" class="navbar-brand-img h-100" alt="main_logo">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class=@yield('dashboard')@yield('normal') href="{{ route('home') }}">
        ...
        <li class="nav-item">
          <a class=@yield('anggota')@yield('normal') href="{{ route('anggota.index') }}">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
        ...
        @if(auth()->user()->role == 'admin')
          <li class="nav-item">
            <a class=@yield('karyawan')@yield('normal') href="{{ route('karyawan.index') }}">
              <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
        ...
        @endif
        <li class="nav-item">
          <a class=@yield('simpanan')@yield('normal') href="{{ route('simpanan.index') }}">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class=@yield('pinjaman')@yield('normal') href="{{ route('pinjaman.index') }}">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class=@yield('transaksi')@yield('normal') href="{{ route('transaksi.index') }}">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class=@yield('profil')@yield('normal') href="{{ url('/login/show') }}">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
